...
@section('content')
    ...
    <div class="row" ng-app="App">
        ...
        <div class="modal fade" id="newModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
             ng-controller="categoryNewController">
                    ...
                    <div class="modal-body">
                        <form>
                            <div class="form-group">
                                ...
                                <input type="text" id="name" class="form-control" ng-model="category.name" required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea rows="5" cols="5" id="description" class="form-control"
                                          ng-model="category.description"></textarea>
                            </div>
                        </form>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Cancelar</button>
                        <button type="button" class="btn btn-primary" ng-click="newCategory(category)">Salvar</button>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                                    aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title" id="myModalLabel">Atualização categoria</h4>
                    </div>
                    <div class="modal-body">
                        <form>
                            <div class="form-group">
        ...
        <script>
            ...
            $(document).on('click', '.deleteModel', function () {
                ...
                swal(
                        ...
                        function () {
                            $.ajax({
                                url: '{{url('/cadastro/categorias')}}/' + model.id,
                                type: 'delete'
            ...
            $('.saveModelEdit').click(function () {
                ...
                $.ajax({
                    url: '{{url('/cadastro/categorias')}}/' + $('#idEdit').val(),
                    type: 'put',
                    data: model,
                    dataType: 'json'
                }).done(function (response) {
            ...
            app.controller('categoryNewController', function ($scope, $http) {
                $scope.newCategory = function (category) {
                    $http({
                        method: 'post',
                        url: '{{url('/cadastro/categorias')}}',
                        data: category
